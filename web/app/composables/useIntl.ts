...
export const CURRENCY_LIST: Array<{ code: string; description: string }> = [
  ...
  { code: 'ANG', description: 'Netherlands Antillean Gulden' },
  ...
  { code: 'CNY', description: 'Chinese Renminbi Yuan' },
  ...
  { code: 'SHP', description: 'Saint Helenian Pound' },
  ...
  { code: 'UZS', description: 'Uzbekistani Som' },
  { code: 'VND', description: 'Vietnamese Đồng' },
