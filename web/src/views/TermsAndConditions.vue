<template>
  <v-container>
        ...
        <v-card>
          ...
          <v-card-text>
            <p>
              ...
              the use of the {{ appData.name }} Website, located at
              <a :href="appData.url">{{ appData.url }}</a
              >.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use {{ appData.name }} if you do
            ...
            <h5 class="text-h5 mb-2">Cookies</h5>

            <p>
              We employ the use of cookies for authentication. By accessing
              {{ appData.name }}, you agreed to use cookies in agreement with
              the
            ...
            <h5 class="text-h5 mb-2">License</h5>

            <p>
              Unless otherwise stated, {{ appData.name }} and/or its licensors
              own the intellectual property rights for all material on
              {{ appData.name }}. All intellectual property rights are reserved.
              You may access this from {{ appData.name }} for your own personal
              use subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from {{ appData.name }}</li>
              <li>
                Sell, rent or sub-license material from {{ appData.name }}
              </li>
              <li>
                Reproduce, duplicate or copy material from {{ appData.name }}
              </li>
              <li>Redistribute content from {{ appData.name }}</li>
            </ul>

            <p>
              Parts of this website offer an opportunity for users to post and
              exchange opinions and information in certain areas of the website.
              {{ appData.name }} does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of {{ appData.name }},its agents
              ...
              by applicable laws, {{ appData.name }}
            ...
            <p>
              {{ appData.name }} reserves the right to monitor all Comments and
            ...
            <p>
              You hereby grant {{ appData.name }} a non-exclusive license to
            ...
            <h5 class="text-h5 mb-2">Hyperlinking to our Content</h5>
            ...
            <p>
              ...
              {{ appData.name }}; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to {{ appData.name }}. Please include your
            ...
            <p>
              No use of {{ appData.name }}'s logo or other artwork will be
              allowed for linking absent a trademark license agreement.
            </p>

            <h5 class="text-h5 mb-2">iFrames</h5>
            ...
            <h5 class="text-h5 mb-2">Content Liability</h5>
            ...
            <h5 class="text-h5 mb-2">Your Privacy</h5>

            <p>
              Please read
              <router-link
                :to="{
                  name: $constants.ROUTE_NAMES.PRIVACY_POLICY,
                }"
                >Privacy Policy</router-link
              >
            </p>

            <h5 class="text-h5 mb-2">Reservation of Rights</h5>
            ...
            <h5 class="text-h5 mb-2">Removal of links from our website</h5>
            ...
            <h5 class="text-h5 mb-2">Disclaimer</h5>
    ...
    <v-row>
      <v-col cols="12">
        <back-button class="d-block mx-auto"></back-button>
      </v-col>
    </v-row>
  </v-container>
</template>
