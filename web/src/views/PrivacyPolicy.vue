    ...
    <v-row>
      <v-col cols="12">
        <v-card>
          ...
          <v-card-text>
            <p>
              At {{ appData.name }}, accessible from
              <a :href="appData.url">{{ appData.url }}</a
              >,one of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is
              collected and recorded by {{ appData.name }} and how we use it.
            </p>
            ...
            <p>
              ...
              that they shared and/or collect in {{ appData.name }}. This policy
              is not applicable to any information collected offline or via
              channels other than this website.
            </p>

            <h2 class="text-h5 mb-2">Consent</h2>
            ...
            <p>
              ...
              <router-link
                :to="{
                  name: $constants.ROUTE_NAMES.TERMS_AND_CONDITIONS,
                }"
                >Terms & Conditions</router-link
              >
            </p>

            <h2 class="text-h5 mb-2">Information we collect</h2>
            ...
            <h2 class="text-h5 mb-2">How we use your information</h2>
            ...
            <h2 class="text-h5 mb-2">Log Files</h2>

            <p>
              {{ appData.name }} follows a standard procedure of using log
            ...
            <h2 class="text-h5 mb-2">Cookies and Web Beacons</h2>

            <p>
              Like any other website, {{ appData.name }} uses 'cookies'. These
            ...
            <h2 class="text-h5 mb-2">Advertising Partners Privacy Policies</h2>

            <P
              >You may consult this list to find the Privacy Policy for each of
              the advertising partners of {{ appData.name }}.</P
            >
            ...
            <p>
              ...
              {{ appData.name }}, which are sent directly to users' browser.
            ...
            <p>
              Note that {{ appData.name }} has no access to or control over
              these cookies that are used by third-party advertisers.
            </p>

            <h2 class="text-h5 mb-2">Third Party Privacy Policies</h2>

            <p>
              {{ appData.name }}'s Privacy Policy does not apply to other
            ...
            <h2 class="text-h5 mb-2">GDPR Data Protection Rights</h2>
            ...
            <h2 class="text-h5 mb-2">Children's Information</h2>
            ...
            <p>
              {{ appData.name }} does not knowingly collect any Personal
